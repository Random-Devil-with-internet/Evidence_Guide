...
You first need to make a function inside that function you will put the button's id after it type in '.textContent' and assgin a string to it. Next outside the function
